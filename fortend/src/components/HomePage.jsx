...
const HomePage = () => {
   return (
      <main className="w-full dark:gridlayout bg-linear2 bg-size h-screen">
         <Navbar />

         <div className="min-h-screen m-auto  transform-[translateY(5rem)] mb-25 h-2000 dark:gridlayout bg-linear2 bg-size">
